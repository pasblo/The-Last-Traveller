...
def Ejecutarajustes(ventana, user_act, ancho, alto, debug_vent = "Pantalla", debug_font = "Calibri"):
	...
	if existe == False:
		...
		datosiniciales = [("ancho", 1280), ("alto", 720), ("pantcomp", "False"), ("fuentegen", "Calibri"), ("Volgen", 10), ("Volefect", 100), ("Volmusic", 100), ("Effectyanimations", "True"), ("Scroll", "True"), ("MaxFPS", "Infinitos"), ("VSync", "True")]
	...
	def set_ajustes(caracteristicas, ventana, vent, ajuste):
		...
		if vent == "Pantalla":
			...
			if ajuste == "TamañoPant":
				...
				pygame.draw.circle(ventana, blanco, (posxcircle1, posycircle1 + ydeinterlineado), 5)
				pygame.draw.circle(ventana, blanco, (posxcircle1, posycircle1 + ydeinterlineado * 2), 5)

			elif ajuste == "PantComp":

				pygame.draw.circle(ventana, blanco, (posxcircle1, posycircle1), 5)
			...
			if ajuste == "VolGen":
				...
				pygame.draw.circle(ventana, blanco, (posxcircle1, posycircle1 + ydeinterlineado), 5)
				pygame.draw.circle(ventana, blanco, (posxcircle1, posycircle1 + ydeinterlineado * 2), 5)
				pygame.draw.circle(ventana, blanco, (posxcircle1, posycircle1 + ydeinterlineado * 3), 5)
				...
				pygame.draw.circle(ventana, blanco, (posxcircle1, posycircle1 + ydeinterlineado), 5)
				pygame.draw.circle(ventana, blanco, (posxcircle1, posycircle1 + ydeinterlineado * 2), 5)
				pygame.draw.circle(ventana, rojo, (posxcircle1, posycircle1 + ydeinterlineado * 3), 5)
			...
			txt7, posxytxt7 = print_pantalla("Maximos FPS: " + MaxFPS, posxtxt, posytxt + ydeinterlineado * 2, tamañotxtajustes, blanco, debug_font)
	...
	def set_parte_especifica(caracteristicas, ventana, ajuste = None):
		...
		if ajuste == None:
			...
			txt_debajo2 = print_pantalla("zar para guardarlo. Si tan solo pruebas, no se guardará.", posxtxtgen, posytxt11, tamañotxtgen, blanco, debug_font)
			...
			dts1 = print_pantalla("Esta función te permite regular el número máximo de", posxtxtgen, posytxt1, tamañotxtgen, blanco, debug_font)

			dts2 = print_pantalla("FPS. A partir de 100 FPS máximos, se consideran infini-", posxtxtgen, posytxt2, tamañotxtgen, blanco, debug_font)

			dts3 = print_pantalla("tos. Los FPS (Frames per second) son el número de", posxtxtgen, posytxt3, tamañotxtgen, blanco, debug_font)
	...
	while Exit_presionado == False:
		...
		for evento in pygame.event.get():
			...
			elif ratonx > 0 and ratony > posyline8 and ratonx < posxfinishlines and ratony < posyline9:
					...
					if evento.type == MOUSEBUTTONDOWN:
						...
						if bot7 != "" and ratonx > posesxybot7[0] and ratony > posesxybot7[1] and ratonx < posesxy2bot7[0] and ratony < posesxy2bot7[1]:
							...
							if pause_play == "play":
								...
								musicadeprueva.setVol(volgenact)
					...
					if evento.type == MOUSEBUTTONDOWN:
						...
						if bot7 != "" and ratonx > posesxybot7[0] and ratony > posesxybot7[1] and ratonx < posesxy2bot7[0] and ratony < posesxy2bot7[1]:
							...
							if pause_play == "play":
								...
								musicadeprueva.setVol((voleffectact * volgenact)/100)
					...
					if evento.type == MOUSEBUTTONDOWN:
						...
						if bot7 != "" and ratonx > posesxybot7[0] and ratony > posesxybot7[1] and ratonx < posesxy2bot7[0] and ratony < posesxy2bot7[1]:
							...
							if pause_play == "play":
								...
								musicadeprueva.setVol((volmusicact * volgenact)/100)
		...
		if ultimoevento == MOUSEBUTTONDOWN and vent_act == "Sonido":
